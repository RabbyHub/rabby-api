...
export type StakingPoolApi = StakingPool;
...
export type StakingPoolListResponseApi = StakingPoolListResponse;
...
export type StakingFilterListResponseApi = StakingFilterListResponse;

export interface StakingPoolResponse {
  pool?: StakingPool;
}

export type StakingPoolDetailResponseApi = StakingPoolResponse;

export type StakingPoolCurvePoint =
  | [number, number]
  | {
      timestamp?: number;
      time_at?: number;
...
export type StakingPoolCurvePointApi = StakingPoolCurvePoint;

export type StakingPoolCurveResponse =
...
export type StakingPoolCurveResponseApi = StakingPoolCurveResponse;
